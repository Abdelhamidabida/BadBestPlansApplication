...
import { fetchBoutiqueVille, fetchnombrecp } from '../../services/PublicationService';
...
function BoutiquesVilleUser() {
  ...
  const [like, setLike] = useState(0),
    ...
    useEffect(() => {
        fetchBoutiqueVille(id).then(res => {
...
export default BoutiquesVilleUser
