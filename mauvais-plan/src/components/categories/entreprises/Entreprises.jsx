...
import { fetchEntPub, fetchResVille, fetchnombrecp } from '../../services/PublicationService'
    ...
    <>
      ...
      <div className='all' >
        ...
        <div className='Arrr'>
          <div className='motr'>
            <div className='trour'>
              Vous Trouver içi les les mauvais plans des entreprises <br></br>sur toute la tunisie</div>
            <div className='zouza'>
              <div className='nomr'>
              ...
              <Button className='searr' variant="light"   > {<Link to={"/EntrepriseVille/" + contenu3} className='boutcommm' >
                Search
              </Link>
              }</Button>
              ...
              <div className='toar'>
                ...
                <Toast key={row._id} >
                  ...
                  <Toast.Body>{row.contenu} {row.photos && row.photos.length > 0 && (
                      <img
