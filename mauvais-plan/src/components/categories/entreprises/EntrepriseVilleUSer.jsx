...
import { fetchEntrepiseVille, fetchnombrecp } from '../../services/PublicationService';
...
function EntrepriseVilleUser() {
  ...
  useEffect(() => {
    fetchEntrepiseVille(id).then(res => {
        ...
        <div className='Arrr'>
          <div className='motr'>
            ...
            <div className='zouza'>
              ...
              <Button className='searr' variant="light"   > {<Link to={"/EntrepriseVilleUser/" + contenu3} className='boutcommm'  >
                Search
              </Link >
              }</Button>
            </div>
...
export default EntrepriseVilleUser
