        ...
        <div className='Arrr'>
          <div className='motr'>
            ...
            <div className='zouza'>
              ...
              <Button className='searr' variant="light"   > {<Link to={"/villeUser/" + contenu3} className='boutcommm' >
                Search
              </Link>
              }</Button>
            </div>{records.map((row, index) => (
              <div className='toar'>
                ...
                <Toast key={row._id} >
                  ...
                  <div className='r2bt'>
                    ...
                    <button className='boutcomr'>{<Link to={"/AjoutcmntUser/" + row._id} className='boutcommm' >
                      <TfiCommentsSmiley style={{ width: '15px', height: '15px', color: '#f5fafc' }} /> &nbsp;Commentaire(s) ({nombre[index]})
                    </Link>
                    }  </button>
                  </div>
                ...
                <div className='toa2'>
                  <Toast  >
                    <Toast.Header>
                      ...
                      <small><TimeElapsedu updatedAt={row.updatedAt} /></small>
                    </Toast.Header>
                    <Toast.Body>{row.contenu_en}</Toast.Body>

                  </Toast></div>
              </div>))} {numbers.length > 0 ? (
