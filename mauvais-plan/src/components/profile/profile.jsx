...
import { MDBCol, MDBContainer, MDBRow, MDBCard, MDBCardText, MDBCardBody, MDBCardImage, MDBBtn, MDBBreadcrumb, MDBBreadcrumbItem, MDBProgress, MDBProgressBar, MDBIcon, MDBListGroup, MDBListGroupItem } from 'mdb-react-ui-kit';
import { useSelector } from 'react-redux';
import { useState, useEffect } from 'react';
import MenuUser from '../../menu/MenuUser';
import { urlimage } from '../../axios/Api';
import { fetchPubEnts, fetchnombrecp } from '../../components/services/PublicationService';
import { ModifierUser } from '../../components/services/UserService';
...
export default function Profile() {
  ...
  useEffect(() => {
    fetchPubEnts(user._id).then(res => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (form.checkValidity() === true) {
      ...
      formData.append("adresse", contenu2);
  ...
  // Fonction pour mettre à jour l'utilisateur avec les valeurs fournies
              ...
              <MDBCard className="mb-4">
                <MDBCardBody className="text-center">
                  <MDBCardImage
                    ...
                    fluid
                  />
                  <p className="text-muted mt-2">{user.nomen}</p>
                  <div className="d-flex justify-content-center mb-2">
                    <Button variant="outline-info" className="ms-1" onClick={handleShow} > Modifier Profil
                    </Button>
                  </div>
                </MDBCardBody>
              </MDBCard>
                ...
                <MDBCardBody className="p-0">
                  <MDBListGroup flush className="rounded-3">
                    <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                      ...
                      <MDBCardText>https://{user.nomen}.com</MDBCardText>
                    </MDBListGroupItem>
                   
                    <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                      <MDBIcon fab icon="twitter fa-lg" style={{ color: '#55acee' }} />
                      <MDBCardText>{user.nomen}</MDBCardText>
                    </MDBListGroupItem>
                    <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                    ...
                    <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                      <MDBIcon fab icon="facebook fa-lg" style={{ color: '#55acee' }} />
                      <MDBCardText>{user.nomen}</MDBCardText>
                    </MDBListGroupItem>
                  </MDBListGroup>
                </MDBCardBody>
              ...
              <MDBCard className="mb-4">
                <MDBCardBody>
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">{user.nomen} {user.nom} {user.prenom}</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
                  ...
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">{user.categorie?.nomcategorie} </MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
                    ...
                    <MDBCol sm="9">
                      <MDBCardText className="text-muted">{user.ville?.nomVille}</MDBCardText>
                    </MDBCol>
                  </MDBRow>
                  <hr />
                  <MDBRow>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3" xs={12} sm={6} >
              <Grid item xs={12} sm={6}>
                <Form.Group as={Col} md="12">
                  ...
                  <Form.Control type="text" placeholder={user.nomen} value={contenu}
              ...
              <Grid item xs={12} sm={6}>
                ...
                <Grid item xs={12} sm={6}>
                  <Form.Group as={Col} md="12">
                    ...
                    <Form.Control type="text" placeholder={user.adresse} value={contenu2}
                ...
                <Grid item xs={12} sm={6}>
                  <Form.Group as={Col} md="12" >
                    <Form.Label style={{ marginRight: '10px' }}>Mot de passe</Form.Label>
            ...
            <Form.Label>Changer le Logo</Form.Label>
            <Form.Control
              type="file"
              name="photos"
